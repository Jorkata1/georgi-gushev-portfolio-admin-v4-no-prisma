              ...
              <article className="surface-strong relative overflow-hidden p-8 sm:p-10 lg:p-12">
                ...
                <div className="relative">
                  ...
                  <div className="mx-auto mt-10 grid max-w-5xl gap-4 sm:grid-cols-2 xl:grid-cols-3">
                    {s.suitableItems.map((item, index) => (
                      <Reveal key={item} delay={index * 0.05}>
                        <div className="group rounded-[1.35rem] border border-white/10 bg-white/[0.04] px-5 py-5 transition hover:border-accent/30 hover:bg-white/[0.06]">
            ...
            {s.services.map((service, index) => {
              ...
              return (
                <Reveal key={service.title} delay={index * 0.06}>
                  <article className="surface card-hover flex h-full flex-col p-6">
              ...
              <div className="grid gap-6 lg:grid-cols-4">
                {s.process.map((item, index) => (
                  <Reveal key={item.step} delay={index * 0.08}>
                    <article className="group surface-strong relative h-full overflow-hidden p-6 transition hover:-translate-y-1 hover:border-accent/20">
